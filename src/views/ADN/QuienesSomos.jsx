  ...
  return (
    <div>
      ...
      <h1 className="text-slate-800 md:text-3xl text-lg font-extralight m-10">
        ...
        <p className="mt-2">
          Nos especializamos en el desarrollo de soluciones integrales, tanto de
          software como de hardware, para el monitoreo, control y gestión de
          sistemas complejos: redes eléctricas, de agua potable,
